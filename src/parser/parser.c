...
#line 1 "/mnt/d/file/code/PROJECTS/plotlang/src/parser/parser.y"
...
#ifndef YY_YY_MNT_D_FILE_CODE_PROJECTS_PLOTLANG_INCLUDE_PARSER_H_INCLUDED
# define YY_YY_MNT_D_FILE_CODE_PROJECTS_PLOTLANG_INCLUDE_PARSER_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
#endif /* !YY_YY_MNT_D_FILE_CODE_PROJECTS_PLOTLANG_INCLUDE_PARSER_H_INCLUDED  */
...
{
  "$end", "error", "$undefined", "ORIGIN", "IS", "L_BRACKET", "COMMA",
  "R_BRACKET", "SEMICOLON", "ROT", "SCALE", "FOR", "T", "FROM", "TO",
  "STEP", "DRAW", "COLOR", "NUMBER", "FUNC", "ERR", "PLUS", "MINUS",
  "MULTIPLE", "DIVISION", "POW", "TEMP", "$accept", "Program", "Statement",
  "OriginStatement", "RotStatement", "ScaleStatement", "ForStatement",
  "ColorStatement", "Expression", YY_NULLPTR
};
#endif
